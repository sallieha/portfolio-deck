        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 64px 0' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', paddingBottom: '32px' }}>
            <div>
              ...
              <h1 style={{ fontSize: '40px', fontWeight: 400, fontFamily: '"Switzer", "Inter", sans-serif', color: '#010103', margin: 0, letterSpacing: '0.06em', textTransform: 'uppercase', opacity: 0, animation: 'headerIn 0.55s ease 0.2s forwards' }}>
                Red Bull + Habit Tracker App
              </h1>
            </div>
            <p style={{ fontSize: '13px', fontWeight: 400, color: '#010103', margin: 0, fontFamily: '"Azeret Mono", monospace', textTransform: 'uppercase', letterSpacing: '0.12em', whiteSpace: 'nowrap', opacity: 0, animation: 'eyebrowIn 0.5s ease 0.3s forwards' }}>
