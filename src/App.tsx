        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 64px 0' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', paddingBottom: '32px' }}>
            <div>
              ...
              <h1 style={{ fontSize: '28px', fontWeight: 600, color: '#010103', margin: 0, letterSpacing: '0.06em', textTransform: 'uppercase', opacity: 0, animation: 'headerIn 0.55s ease 0.2s forwards' }}>
